                    ...
                    <div class="card-header bg-thumb-big">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-end">
                                ...
                                <a href="{{url('')}}/preview" class="btn btn-outline-primary">Preview</a>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-check">
                                                                                    <input
                                                                                        ...
                                                                                        type="checkbox" id="kustom-1" name="lainnya[]"
                                                                                        value="Lainnya">
                            ...
                            <div class="tab-pane fade show active" id="pills-pertanyaan" role="tabpanel"
                                ...
                                {{-- <div class="row align-items-center">
                                    <div class="col-12 text-center py-5">
                                        ...
                                        <b class="text-disabled">Pertanyaan Belum Ditambahkan</b>
                                        <p class="text-disabled">Tambahkan pertanyaan untuk surveymu disini</p>
                                    </div>
                                </div> --}}
                            </div>
